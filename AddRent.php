...
<body>
<h1>Please enter rental details</h1>
...
<?php
	...
	if(isset($_POST['submit1'])){
		...
		$resultSet = $mysqli->query("INSERT INTO rent(product_id,rented_on,from_location,num_of_copies,price,customer_id,duration)
						VALUES('$pid','$date','$location','$copies','$price','$cust_id','$duration')");
	...
	<div class="container">
					<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
						...
						<p>Rented On(YYYY-MM-DD) : <input align="right" type="text" name="date"></p>
						...
						<p>Duration: <input align="right" type="text" name="duration"></p>
