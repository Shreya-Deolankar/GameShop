...
<!DOCTYPE html>
	...
	<?php
		...
		$query4 = "SELECT p.product_name,c.cust_fname,c.cust_lname,pr.bought_on,pr.from_location,pr.num_of_copies,pr.price
					FROM purchase pr, product p, customer c
					WHERE pr.product_id = p.product_id
					AND pr.customer_id = c.cust_id
        ...
        <th align="left"></th>
        <th align="left"><b><font size="+2">Purchase Details</font></th>
        <th align="left"></th>
        <th align="left"></th></tr>
		...
		$row4['product_name'] . '</td><td align="left">' . 
		$row4['cust_fname'] . '</td><td align="left">' .
		$row4['cust_lname'] . '</td><td align="left">' .
		$row4['price'] . '</td><td align="left">' .
		$row4['bought_on'] . '</td><td align="left">' .
		$row4['from_location'] . '</td><td align="left">' .
		$row4['num_of_copies'] . '</td><td align="left">';
