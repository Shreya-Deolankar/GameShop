...
<!DOCTYPE html>
	...
	<div class="tab">
	  ...
	  <button class="tablinks" onclick="location.href='tab6.php'">Dependent Details</button>
		...
		<tr><td align="left"><br><form align="center" action="home.php" method="get">
		
		<br><input type = "SUBMIT" name = "home" value = "Home" style="font-size : 14px;height:35px;width:105px"/> </br>

	    </form></br></td>

	    <td align="left"><br><form align="center" action="AddCust.php" method="get">
		...
		<br><input type = "SUBMIT" name = "EditSupp" value = "Edit Supplier" style="font-size : 14px;height:35px;width:105px"/></br>
	     ...
	     <td align="left"><br><form align="center" action="AddDep.php" method="get">
	    ...
	    <td align="left"><br><form align="center" action="EditDep.php" method="get">
	...
	<?php
        ...
        <tr><th align = "left"></th>
        <th align="left"></th>
        <th align="left"><b><font size="+2">Dependent Details</font></th>
        <th align="left"></th>
        <th align="left"></th></tr>
		<tr><th align="left"><b>Employee First Name</th>
		<th align="left"><b>Employee Last Name</th>
		...
		$row5['fname'] . '</td><td align="left">' . 
		$row5['lname'] . '</td><td align="left">' .
