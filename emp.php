...
<!DOCTYPE html>
    ...
    <div class="tab">
	  <button class="tablinks" onclick="location.href='tab1.php'" id="defaultOpen">List Of Customers</button>
	  ...
	  <button class="tablinks" onclick="location.href='tab6.php'">Dependent Details</button>
		...
		<br><input type = "SUBMIT" name = "AddDep" value = "Add Dependent" style="font-size : 14px;height:35px;width:105px"/></br>
		...
		<br><input type = "SUBMIT" name = "EditDep" value = "Edit Dependent" style="font-size : 14px;height:35px;width:105px"/></br>
